...
**Advanced está aceptado y entregado** mediante el [issue #75](https://github.com/JFrancoG/MangaLibrary/issues/75) y la [PR #76](https://github.com/JFrancoG/MangaLibrary/pull/76). **Deluxe tiene siete subfases en el [plan #77](https://github.com/JFrancoG/MangaLibrary/issues/77): DX1 aprobado y publicado; DX2 implementado y validado localmente en el [issue #79](https://github.com/JFrancoG/MangaLibrary/issues/79), pendiente de entrega Git (2/7 cortes técnicos).** El [contrato de lectura y recuperación](docs/specs/09-deluxe-reading-contract.md) y [Progress](docs/Progress.md) registran alcance, pruebas y límites. Siguiente unidad: DX3, publicación por eventos de Colección y portadas, todavía sin iniciar. Los targets widget/watch y el App Group efectivo pertenecen a sus siguientes subfases; la evidencia física de Apple Watch sigue pendiente.
