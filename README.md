...
**L2 — Colección local y offline** está entregada mediante la [PR #50](https://github.com/JFrancoG/MangaLibrary/pull/50), vinculada al [issue #49](https://github.com/JFrancoG/MangaLibrary/issues/49). El esquema V2 añade la presentación offline; la UI filtra por identidad activa con `@Query` y las altas, ediciones y tombstones recorren la capacidad atómica compartida. **R1 — lectura e importación remota** se entrega mediante la [PR #54](https://github.com/JFrancoG/MangaLibrary/pull/54), vinculada al [issue #53](https://github.com/JFrancoG/MangaLibrary/issues/53), con snapshot completo, commit SwiftData único y protección por generación de sesión. **R2 — envío y reconciliación de outbox** está en curso mediante el [issue #57](https://github.com/JFrancoG/MangaLibrary/issues/57): R2.1 implementa localmente POST y reconciliación conservadora; R2.2 añade GET/DELETE individual, envío de tombstones y confirmación destructiva en el editor. La caracterización live de los paths individuales sigue siendo obligatoria antes de aceptar o mezclar R2.2; retry/backoff, `blockedAuth`, rechazo/reversión y resolución manual permanecen pendientes. Entitlements, WidgetKit y watchOS también quedan fuera. La [hoja de ruta Advanced](docs/Progress.md#hoja-de-ruta-advanced) delimita esas unidades.
