...
El [contrato](docs/specs/09-deluxe-reading-contract.md), [Progress](docs/Progress.md) y la [checklist DX4](docs/dx4-widget-validation.md) conservan el alcance de los renders y sus límites. El issue sigue abierto con las pruebas físicas de DX4.5 pendientes: protección antes del primer desbloqueo, privacidad, retirada y rotación sin debugger, y VoiceOver en iPhone. La instalación de desarrollo y el App Group efectivos ya están acreditados en iPhone 11. La ampliación combinatoria pertenece a DX6. DX4 no necesita Apple Watch y aún no se ha entregado. **El Deluxe Release Gate no está superado.**
