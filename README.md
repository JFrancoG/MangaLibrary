...
**Advanced está aceptado y entregado** mediante el [issue #75](https://github.com/JFrancoG/MangaLibrary/issues/75) y la [PR #76](https://github.com/JFrancoG/MangaLibrary/pull/76). **Deluxe tiene siete subfases en el [plan #77](https://github.com/JFrancoG/MangaLibrary/issues/77): DX1 y DX2 completan los dos primeros cortes (2/7), con entrega mediante las PR [#80](https://github.com/JFrancoG/MangaLibrary/pull/80) y [#81](https://github.com/JFrancoG/MangaLibrary/pull/81).** El [contrato de lectura y recuperación](docs/specs/09-deluxe-reading-contract.md) y [Progress](docs/Progress.md) registran alcance, pruebas y límites. DX3.1 — proyección persistida — está implementado y validado localmente en el [issue #82](https://github.com/JFrancoG/MangaLibrary/issues/82), sin entrega Git; DX3 avanza 1/5 bloques. Siguiente bloque: DX3.2, prefijo estable y supresión de publicaciones sin cambios, todavía sin iniciar. Los targets widget/watch y el App Group efectivo pertenecen a sus siguientes subfases; la evidencia física de Apple Watch sigue pendiente.
