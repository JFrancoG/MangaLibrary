...
**Advanced está aceptado y entregado** mediante el [issue #75](https://github.com/JFrancoG/MangaLibrary/issues/75) y la [PR #76](https://github.com/JFrancoG/MangaLibrary/pull/76). **Deluxe tiene siete subfases en el [plan #77](https://github.com/JFrancoG/MangaLibrary/issues/77): DX1 y DX2 completan los dos primeros cortes (2/7), con entrega mediante las PR [#80](https://github.com/JFrancoG/MangaLibrary/pull/80) y [#81](https://github.com/JFrancoG/MangaLibrary/pull/81).** El [contrato de lectura y recuperación](docs/specs/09-deluxe-reading-contract.md) y [Progress](docs/Progress.md) registran alcance, pruebas y límites. DX3.1 — proyección persistida — está publicado en `db5d2eb`; DX3.2 — prefijo estable y supresión de publicaciones sin cambios — en `95213ed`. DX3.3 — portadas acotadas y recuperación — está publicado en `99203db`. DX3.4 — eventos y orden de publicación — está publicado en `8ca565d`. DX3.5 queda validado localmente en el [issue #82](https://github.com/JFrancoG/MangaLibrary/issues/82): DX3 completa sus 5/5 bloques técnicos, con 662 tests/910 invocaciones y builds Debug/Release y DocC sin warnings. Su commit/push y la entrega de DX3 siguen pendientes. Los targets widget/watch y el App Group efectivo pertenecen a sus siguientes subfases; la evidencia física de Apple Watch sigue pendiente.
