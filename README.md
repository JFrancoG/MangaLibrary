...
El repositorio privado ha iniciado producto con [Catálogo C1](https://github.com/JFrancoG/MangaLibrary/issues/13): el shell estable ofrece Catálogo, Colección y Cuenta; Catálogo carga la primera página pública, representa carga/contenido/vacío/error y abre un resumen de detalle por `Manga.ID` sin una segunda petición. [Catálogo C2](https://github.com/JFrancoG/MangaLibrary/issues/21) añade paginación incremental y una presentación común en lista o cuadrícula. [Catálogo C3](https://github.com/JFrancoG/MangaLibrary/issues/25) incorpora búsqueda avanzada paginada por texto y autoría, filtros combinables de demografía, género y tema en un inspector adaptativo, y el conjunto exclusivo «Mejores». [Catálogo C4](https://github.com/JFrancoG/MangaLibrary/issues/27), actualmente en desarrollo local, enriquece cada manga y su detalle con estado, autoría y clasificaciones, amplía y anima localmente la portada del destino y anticipa la siguiente página al aproximarse al final. Colección, autenticación, sincronización, widget y watchOS continúan pendientes.
