...
**Advanced está aceptado y entregado** mediante el [issue #75](https://github.com/JFrancoG/MangaLibrary/issues/75) y la [PR #76](https://github.com/JFrancoG/MangaLibrary/pull/76), fusionada el 6 de septiembre de 2026. **El plan Deluxe del [issue #77](https://github.com/JFrancoG/MangaLibrary/issues/77) está aprobado**, con siete subfases y criterios de cierre. **DX1 tiene contrato aprobado y preparación completada en el [issue #78](https://github.com/JFrancoG/MangaLibrary/issues/78): 1/7 subfases**, pendiente de entrega Git. El [contrato de lectura](docs/specs/09-deluxe-reading-contract.md) incluye fixtures y la matriz para avanzar sin Apple Watch físico, conservando pendiente su evidencia de integración y accesibilidad real. La siguiente unidad es DX2, aún sin iniciar; las capacidades ejecutables Deluxe todavía no están implementadas.
