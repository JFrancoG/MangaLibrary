...
**Advanced está aceptado y entregado** mediante el [issue #75](https://github.com/JFrancoG/MangaLibrary/issues/75) y la [PR #76](https://github.com/JFrancoG/MangaLibrary/pull/76). **Deluxe tiene siete subfases en el [plan #77](https://github.com/JFrancoG/MangaLibrary/issues/77): DX1 y DX2 completan los dos primeros cortes (2/7), con entrega mediante las PR [#80](https://github.com/JFrancoG/MangaLibrary/pull/80) y [#81](https://github.com/JFrancoG/MangaLibrary/pull/81).** El [contrato de lectura y recuperación](docs/specs/09-deluxe-reading-contract.md) y [Progress](docs/Progress.md) registran alcance, pruebas y límites. Siguiente unidad: DX3, publicación por eventos de Colección y portadas, todavía sin iniciar. Los targets widget/watch y el App Group efectivo pertenecen a sus siguientes subfases; la evidencia física de Apple Watch sigue pendiente.
