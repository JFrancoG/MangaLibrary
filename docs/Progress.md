...
- El [issue #75 — certificar la versión Advanced](https://github.com/JFrancoG/MangaLibrary/issues/75) parte de `main@aa2e475`, limpio y sincronizado con `origin/main`, en la rama `codex/75-advanced-release-gate`. La entrega permanece abierta hasta completar las tres tecnologías de asistencia manuales pendientes.
...
- Previews, simulador y tests no prueban Voice Control, Switch Control ni Acceso total con teclado. El Advanced Release Gate continúa pendiente de esas tres comprobaciones manuales vigentes; hasta entonces el issue y la PR permanecen abiertos y Deluxe no puede comenzar.
