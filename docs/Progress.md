...
**Estado general:** G0, Catálogo C1–C4, D1, Q1, P1, Library Red, S1, S2 y S2.1 entregados; S2.2 se entrega mediante la PR #40; L1 sigue siendo el siguiente corte y no se ha iniciado
...
La lista de capacidades de la SDD 00 es una puerta de aceptación, no un orden de implementación. El orden operativo parte de dos decisiones ya aprobadas: la colección local se identifica por **usuario + manga** y no existe una política de colección anónima. S1, S2 y S2.1 están entregados; S2.2 se entrega mediante la PR #40; L1 continúa después. La secuencia completa es:
