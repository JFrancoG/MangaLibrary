...
- [09 — Contrato de lectura Deluxe](specs/09-deluxe-reading-contract.md) — DX1 aprobado, recuperación DX2 y consulta persistida DX3.1; incluye matriz de pruebas sin Apple Watch físico y evidencia pendiente.
