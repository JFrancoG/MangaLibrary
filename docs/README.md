...
- [09 — Contrato de lectura Deluxe](specs/09-deluxe-reading-contract.md) — DX1 aprobado, recuperación DX2 y publicación DX3; gate técnico DX3.5 validado localmente en [Progress](Progress.md), pendiente de entrega. Incluye matriz de pruebas sin Apple Watch físico y evidencia pendiente.
